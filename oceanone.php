  ...
  <body>
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid container">
          ...
          <div class="navbar-brand " href="#">
                <img class="imglogo" src="assets/oceanone.png"   >
          </div>
    ...
    <div class="sectiontwo section container mb-5">
          ...
          <div class="button-group">
            <button class="btn mt-auto" style="background-color: #06BEE1; font-family: Lato; font-weight: 500; color: white;">LEARN MORE</button>
      ...
      <div class="sectionthree section pb-5">
        ...
        <div class="row mt-5">
          ...
          <div class="col-sm-4 d-flex flex-column">
            ...
            <img src="assets/57f581009bd978d11b8b4ebe.jpg"  class="rounded-circle mx-auto" style="width: 150px; height: 150px;">
          ...
          <div class="col-sm-4 d-flex flex-column ">
            ...
            <img src="assets/5999165366_ee15cbe1b2_b.0.jpg"  class="rounded-circle mx-auto" style="width: 150px; height: 150px;">
          ...
          <div class="col-sm-4 d-flex flex-column">
            ...
            <img src="assets/ocg-saving-the-ocean--h4B4-jzfnw-unsplash.jpg"   class="rounded-circle mx-auto" style="width: 150px; height: 150px;">
    ...
    <div class="sectionfour">
      <div class=" section">
        ...
        <div class="row" >
          ...
          <div class="col-xs-12 col-sm-6 col-md-6 e d-flex " style="height: 400px; background: #06BEE1;">
        ...
        <div class="row" >
          ...
          <div class="col-xs-12 col-sm-6 col-md-6 e d-flex order-lg-1 order-md-1 order-sm-1" style="height: 400px; background: #06BEE1;">
            <div class="my-auto col-lg-12 col-12">
            ...
            <div class=" col-12">
                <div class="row justify-content-center"> 
                    <div class="col-md-3 col-12 font-italic align-items-center  mt-md-3 mt-4">
                      <h5>
                        <span> 
                          <img src="assets/oceanone.png" class="img-fluid mb-1 imglogo"  >
                    ...
                    <small class="copy-rights cursor-pointer">&#9400; 2023 Darriel Markerizal</small><br>
